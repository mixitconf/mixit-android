...
data class UserDto(val login: String, val firstname: String, val lastname: String, val company: String?, val photoUrl: String?, val description: Map<Language, String> = emptyMap(), val links: List<LinkDto> = emptyList())
